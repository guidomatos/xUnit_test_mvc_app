...
namespace LibraryMvcApp.Test
{
    public class BooksControllerTest
    {
        ...
        public void CreateTest()
        {
            ...
            //assert
            var redirectToActionResullt = Assert.IsType<RedirectToActionResult>(result);
            Assert.Equal("Index", redirectToActionResullt.ActionName);
            Assert.Null(redirectToActionResullt.ControllerName);
